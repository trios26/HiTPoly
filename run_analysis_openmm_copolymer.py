...
def run(
    ...
    print("Final atom_name_list being passed to get_coords_PDB_msd:")
...
#################################################################################### skip
    ...
    #     )
    #     distance_coord = return_distance_coordination(data=data_coordination, folder=folder)

    #     make_barplot_coordination_atomtypes(
    #         data=data_coordination,
    #        ccd  coord_env=coord_env_atomtypes,
